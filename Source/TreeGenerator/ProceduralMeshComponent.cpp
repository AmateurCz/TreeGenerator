...
public:
		...
		, MaterialRelevance(Component->GetMaterialRelevance(GetScene().GetFeatureLevel()))
	{
		...
		for (int TriIdx = 0; TriIdx<Component->ProceduralMeshTris.Num(); TriIdx++)
		{
			...
			Vert0.SetTangents(Tri.Vertex0.Normal, Tri.Vertex0.Tangent, Tri.Vertex0.Bitangent);
			...
			Vert1.SetTangents(Tri.Vertex1.Normal, Tri.Vertex1.Tangent, Tri.Vertex1.Bitangent);
			...
			Vert2.SetTangents(Tri.Vertex2.Normal, Tri.Vertex2.Tangent, Tri.Vertex2.Bitangent);
